...
public class StrictAtomicSubscriberTest extends AbstractStrictSubscriberTest {

    @Override
    public RelaxedSubscriber<Object> create(Subscriber<Object> actual, final List<Throwable> undeliverables) {
        return new StrictAtomicSubscriber<Object>(actual) {
            @Override
    ...
    public RelaxedSubscriber<Object> wrap(Subscriber<Object> actual) {
        return StrictAtomicSubscriber.wrap(actual);
    }
